...
const ColorSchemePreview = () => {
  ...
  const UIExamples = ({ colors }) => (
    <div className="space-y-8">
      ...
      <div className="rounded-t-lg overflow-hidden">
        <div className="p-4" style={{ backgroundColor: colors.primary }}>
          <div className="text-white flex justify-between items-center">
            <span className="font-bold">Nobel Akademi</span>
      ...
      >
        ...
        <p className="mb-4">Bergabunglah dengan ribuan pelajar di seluruh dunia</p>
        <button
        ...
        <table className="min-w-full border" style={{ backgroundColor: colors.accent }}>
          <thead>
            <tr style={{ backgroundColor: colors.secondary }}>
              <th className="py-2 px-4 border" style={{ color: colors.accent }}>
                ID
              </th>
              <th className="py-2 px-4 border" style={{ color: colors.accent }}>
                Nama
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 border" style={{ color: colors.primary }}>
                1
              </td>
              <td className="py-2 px-4 border" style={{ color: colors.primary }}>
                Alice
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">8 Pallet Warna Nobel Akademi</h1>
      </div>


      {/* Pemilih Skema Warna */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Pilih Skema Warna</h2>
        <div className="grid grid-cols-4 gap-2">
          {Object.entries(colorSchemes).map(([key, scheme]) => (
            <button
              key={key}
              onClick={() => setSelectedScheme(key)}
              className={`p-3 rounded text-left cursor-pointer ${
                selectedScheme === key
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg">
        ...
        {/* Contoh Komponen UI */}
        <div className="mb-8">
          <h4 className="font-bold mb-4">Contoh Penggunaan Komponen UI</h4>
